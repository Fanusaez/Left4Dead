...
std::int16_t Configuration::get_soldier_health_when_reviving() {
    return soldier_health_when_reviving;
}

std::int16_t Configuration::get_soldier_times_can_be_revived() {
