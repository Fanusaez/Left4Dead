...
public:
    ...
    std::vector<char> serialize_create_scenario(std::string *scenario_name);

    std::vector<char> serialize_join_scenario(int32_t *scenario_code);
    ...
    std::vector<char> serialize_throw_grenede(int *time);
};
#endif
